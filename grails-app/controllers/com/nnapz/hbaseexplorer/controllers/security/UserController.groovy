...
class UserController {
    ...
    def save() {
		...
		def roleInstance = Role.findByAuthority(params.authority);
		userInstance.refresh()
		
		def userRole = UserRole.create userInstance, roleInstance
    ...
    def edit() {
        ...
        [userInstance: userInstance , userAuthority : userInstance.getCurrentAuthority()?.authority]
    }
